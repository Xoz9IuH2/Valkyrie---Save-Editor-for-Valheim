# Steam Guide Publication

Create two separate guides so each has the correct language selection.

1. Open Valheim in your Steam Library and follow Community Hub > Guides > Create a Guide (labels can vary with Steam's interface language).
